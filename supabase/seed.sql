...
values
  ...
  ('30000000-0000-4000-8000-000000000045', '20000000-0000-4000-8000-000000000004', 'Ramen', 5),
...
values
  ...
  -- Sushi Nocturno
  ('40000000-0000-4000-8000-000000000041', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000041', 'California roll', 'Cangrejo, aguacate y pepino cubierto de ajonjolí.', 26900, 'https://images.unsplash.com/photo-1611143669185-af224c5e3252?auto=format&fit=crop&w=1200&q=80', 1, '{"popular"}'),
  ('40000000-0000-4000-8000-000000000042', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000041', 'Roll acevichado', 'Roll de langostino crocante bañado en salsa acevichada.', 32900, 'https://images.unsplash.com/photo-1559410545-0bdcd187e0a6?auto=format&fit=crop&w=1200&q=80', 2, '{"popular","picante"}'),
  ('40000000-0000-4000-8000-000000000043', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000041', 'Roll tempura de camarón', 'Camarón tempura, aguacate y salsa de anguila.', 31900, 'https://images.unsplash.com/photo-1607301405390-d831c242f59b?auto=format&fit=crop&w=1200&q=80', 3, '{}'),
  ('40000000-0000-4000-8000-000000000044', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000042', 'Nigiri de salmón', 'Dos piezas de salmón fresco sobre arroz de sushi.', 14900, 'https://images.unsplash.com/photo-1583623025817-d180a2221d0a?auto=format&fit=crop&w=1200&q=80', 1, '{}'),
  ('40000000-0000-4000-8000-000000000045', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000042', 'Nigiri de atún', 'Dos piezas de atún rojo sobre arroz de sushi.', 15900, 'https://images.unsplash.com/photo-1617196034796-73dfa7b1fd56?auto=format&fit=crop&w=1200&q=80', 2, '{}'),
  ('40000000-0000-4000-8000-000000000046', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000043', 'Gyozas de cerdo', 'Seis gyozas a la plancha con salsa ponzu.', 16900, 'https://images.unsplash.com/photo-1541696432-82c6da8ce7bf?auto=format&fit=crop&w=1200&q=80', 1, '{}'),
  ('40000000-0000-4000-8000-000000000047', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000043', 'Sopa miso con setas', 'Caldo de miso con champiñones, cebollín y un toque de ají.', 11900, 'https://images.unsplash.com/photo-1512003867696-6d5ce6835040?auto=format&fit=crop&w=1200&q=80', 2, '{"vegetal"}'),
  ('40000000-0000-4000-8000-000000000048', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000044', 'Té verde frío', 'Té verde con jazmín, servido con hielo.', 7900, 'https://images.unsplash.com/photo-1515823064-d6e0c04616a7?auto=format&fit=crop&w=1200&q=80', 1, '{"bebida"}'),
  ('40000000-0000-4000-8000-000000000049', '20000000-0000-4000-8000-000000000004', '30000000-0000-4000-8000-000000000045', 'Ramen tonkotsu', 'Caldo de cerdo de doce horas, chashu, huevo marinado y cebollín.', 34900, 'https://images.unsplash.com/photo-1557872943-16a5ac26437e?auto=format&fit=crop&w=1200&q=80', 1, '{"popular"}'),
  -- Pizzería Ragazzi
